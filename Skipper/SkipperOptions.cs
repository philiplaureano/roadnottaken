...
namespace Skipper
{
    public class SkipperOptions
    {
        ...
        [Option('s', "skipListFile", Required = true,
            HelpText =
                "The location of the skip list file that contains the list of single line test method entries that will be marked for skipping (in the form of Project.Namespace.TestType.TestMethodName, one entry per line, or a Regex expression).")]
